...
`PYENV_QUICK_WHICH` | unset | If this variable is 1, `pyenv which` won't report versions where the command is installed.  This can improve performance in some circumstances.
